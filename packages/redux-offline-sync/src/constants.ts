...
export const JS_ERROR = '@offline-sync/JS_ERROR';
export const DEFAULT_COMMIT = '@offline-sync/DEFAULT_COMMIT';
export const DEFAULT_ROLLBACK = '@offline-sync/DEFAULT_ROLLBACK';

/** @todo Is it needed? Obtain from redux-persist? */
